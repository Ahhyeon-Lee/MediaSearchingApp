...
interface FavoriteDao {
    ...
    @Query("DELETE FROM ImageDocumentEntity WHERE thumbnail = :thumbnail")
    suspend fun deleteFavoriteImageData(thumbnail: String)

    @Query("DELETE FROM VideoDocumentEntity WHERE thumbnail = :thumbnail")
    suspend fun deleteFavoriteVideoData(thumbnail: String)
}